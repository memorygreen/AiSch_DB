...
-- ROLE 이란?
--> 여러 권한을 한번에 부여하기 위해 사용하는 명령어다.
-- 비슷한 종류의 권한끼리 모아 높은 ROLE이라는 개념으로 한번에 권한을 묶어서 부여한다.

-- [ ROLE의 종류 ]
-- CONNECT  : 데이터베이스에 접속에 필요한 권한 이 묶여져 있는 ROLE
...
--> 즉 HR소유 테이블에 DCLTEST 사용자가 SELECT나 INSERT 등의 작업이 가능하도록
-- 허용 할 수 있게 하는 것 
